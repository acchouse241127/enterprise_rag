...
description_zh: Everything Claude Code 交互式安装器——引导用户选择并安装技能与规则到用户级或项目级目录，验证路径并可选优化已安装文件。
---

# Configure Everything Claude Code (ECC) / 配置 Everything Claude Code (ECC)
